...
function AboutMeBio({ onTabClick }: any) {
            ...
            <div className="flex-col">
                <div className="flex border-1 border-b-0 border-white/20 rounded-t-lg bg-[#1f2938]">
                    <div className="flex border-1 border-t-0 border-b-0 border-l-0 border-white/20 rounded-tl-lg">
                        <button type="button" onClick={() => onTabClick('bio')} className="flex w-full h-full pt-3 pb-3 pl-3 pr-5 rounded-tl-lg border-b-2 border-b-terminal-blue border-r-1 border-r-white/20 bg-current/2 cursor-pointer focus:outline-none">
                        ...
                        <button type="button" onClick={() => onTabClick('timeline')} className="flex w-full h-full pt-3 pb-3 pl-3 pr-5 transition duration-300 ease-in-out hover:bg-current/10 cursor-pointer focus:outline-none">
                            <div className="flex pl-3 gap-2">
                ...
                <div className="flex-col rounded-b-lg bg-[#161d28] border-1 border-white/20">
                    <div className="p-7">
                        ...
                        <p className="pb-1">7&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span><span className="text-terminal-green">"Undergraduate researcher"</span>,</span> </p>
                        <p className="pb-1">7&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span><span className="text-terminal-green">"Computing student mentor"</span></span> </p>
                    ...
                    <div className="flex w-5xl p-7">
                        <p className="text-center">An excited developer who's ready to learn as much as possible. I love coding and can lose myself for hours developing
                            software. I'm always eager to learn and enjoy the process of getting better at things I'm passionate about. Outside of 
                            CS, I like to play video games and workout.
                        </p>
                    </div>
                </div>
